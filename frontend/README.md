# CineSaga Project's Frontend React App
This React project is the frontend codes of CineSagaMicroservice project.
...
Check Node and npm before installing dependencies:

    node --version
    npm --version

This frontend is configured for Node.js 22.x. If `node --version` works but
`npm --version` fails on Windows, repair the Node.js installation or run npm
through the Node installation directly:
